...
public class RadioButtonPageTest extends BasePageTest {
    ...
    void testYesAndImpressiveRadioButton() {
        ...
        if (!driver.findElement(YES_LABEL_BUTTON_LOCATOR).isSelected()) {
        ...
        if (!driver.findElement(IMPRESSIVE_LABEL_BUTTON_LOCATOR).isSelected()) {
        ...
        if (!driver.findElement(NO_LABEL_BUTTON_LOCATOR).isSelected()) {
